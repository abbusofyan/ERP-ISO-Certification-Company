				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control flatpickr-basic quote_date" title="Quote Date" name="bizsafe-quote_date" id="quote_date" value="<?= $quotation->quote_date ?>" required>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group ui-widget">
							<label for="referred_by">Referred By <span class="text-danger">*</span></label>
							<input type="text" class="form-control" id="bizsafe_referred_by" title="Referred By" name="bizsafe-referred_by" value="<?= $quotation->referred_by ?>" required>
						</div>
					</div>
