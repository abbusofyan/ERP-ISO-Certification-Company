...
if (ENVIRONMENT == 'production') {
    $config['base_url'] = 'https://cvs.asasg.com';
} else {
...
|
*/
$config['encryption_key'] = 'Q2YZtavC7TvioY#=9y[XR{b6h,9oxpN7/Gq=a6vFJgtFwnEJk#b3Mtu3xLGz(2.o';
