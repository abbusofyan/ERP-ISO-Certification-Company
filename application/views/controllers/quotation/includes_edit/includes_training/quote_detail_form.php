				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control flatpickr-basic quote_date" title="Quote Date" name="training-quote_date" id="quote_date" value="<?= $quotation->quote_date ?>" required>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group ui-widget">
							<label for="referred_by">Referred By <span class="text-danger">*</span></label>
							<input type="text" class="form-control" id="training_referred_by" title="Referred By" name="training-referred_by" value="<?= $quotation->referred_by ?>" required>
						</div>
					</div>
					...
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control select2 select-select2 multiple" multiple="multiple" name="training-group_company[]" id="select-group-of-companies">
