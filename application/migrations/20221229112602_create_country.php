...
class Migration_Create_Country extends CI_Migration
{
    public function up()
    {
        ...
        $insert_table = "INSERT INTO `countries`(`code`, `name`, `currency_code`, `fips_code`, `iso_numeric`, `north`, `south`, `east`, `west`, `capital`, `continent_name`, `continent`, `languages`, `iso_alpha3`, `geoname_id`) VALUES
