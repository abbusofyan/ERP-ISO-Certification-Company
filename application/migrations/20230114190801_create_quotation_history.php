...
class Migration_Create_Quotation_History extends CI_Migration
{
    public function up()
    {
        if (!$this->db->table_exists('quotation_history')) {
			...
			$this->dbforge->create_table('quotation_history', true);
        }
    ...
    {
        $this->dbforge->drop_table('quotation_history', true);
    }
}
