				...
				<div class="row">
					...
					<div class="col-6">
						<div class="form-group">
							...
							<textarea name="training-training_description" rows="3" id="training_description" placeholder="training description" class="form-control" title="Training Description" required></textarea>
						</div>
					</div>
				</div>
			</div>
