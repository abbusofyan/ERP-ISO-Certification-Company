				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control flatpickr-basic quote_date" title="Quote Date" name="iso-quote_date" id="quote_date" required>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group ui-widget">
							<label for="referred_by">Referred By <span class="text-danger">*</span></label>
							<input type="text" class="form-control" id="iso_referred_by" title="Referred By" name="iso-referred_by" required>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
					...
					<div class="col-6 transfer-related-field">
						<div class="form-group">
							...
							<input type="text" class="form-control flatpickr-basic" id="prev-cert-issue-date" name="iso-prev_cert_issue_date">
						</div>
					</div>
					<div class="col-6  transfer-related-field">
						<div class="form-group">
							<label for="prev_cert_exp_date">Previous Cert Exp Date</label>
							<input type="text" class="form-control flatpickr-basic" id="prev-cert-exp-date" name="iso-prev_cert_exp_date">
						</div>
					</div>
					<div class="col-6  transfer-related-field">
						<div class="form-group">
							<label for="prev_standard">Previous Standard (Certification Scheme)</label>
							<input type="text" class="form-control" id="prev-standard" name="iso-prev_certification_scheme">
						</div>
					</div>
					<div class="col-6  transfer-related-field">
						<div class="form-group">
							<label for="prev_accreditation">Previous Accreditation</label>
							<input type="text" class="form-control" id="prev-accreditation" name="iso-prev_accreditation">
						</div>
					</div>
					<div class="col-6  transfer-related-field">
						<div class="form-group">
							<label for="prev_cb">Previous Certification Body (CB)</label>
							<input type="text" class="form-control" id="prev-cb" name="iso-prev_certification_body">
						</div>
					</div>
					<div class="col-6  transfer-related-field">
						<div class="form-group">
					...
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control select2 select-select2 multiple" name="iso-group_company[]" multiple="multiple" id="select-group-of-companies">
					...
					<div class="col-6 consultant_pay_3_years_field">
						...
						<div class="form-control-plaintext">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="iso-consultant_pay_3_years" id="consultant_pay_three_years_1" value="Yes">
								<label class="form-check-label" for="consultant_pay_three_years_1">Yes</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="iso-consultant_pay_3_years" id="consultant_pay_three_years_0" value="No" checked>
					...
					<div class="col-6 client_pay_3_years_field">
						...
						<div class="form-control-plaintext">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="iso-client_pay_3_years" id="invoice_pay_three_years_1" value="Yes">
								<label class="form-check-label" for="invoice_pay_three_years_1">Yes</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="iso-client_pay_3_years" id="invoice_pay_three_years_0" value="No" checked>
						...
						<div class="input-group ui-widget mb-2">
							<select class="form-control select2" name="iso-application_form">
								...
								<?php foreach ($application_form as $form): ?>
									<option value="<?= $form->number ?>">#<?= $form->number ?> (<?= $form->client_name ?>)</option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
