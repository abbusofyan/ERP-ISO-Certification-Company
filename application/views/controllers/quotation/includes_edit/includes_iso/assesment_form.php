				...
				<div class="row">
					<div class="col-6 assesment_fee" id="iso-stage_audit">
						<div class="form-group">
							...
							<input type="number" class="form-control" name="iso-stage_audit" title="Stage Audit" value="<?= $quotation->stage_audit ?>" required>
						</div>
					</div>
					<div class="col-6 assesment_fee" id="iso-surveillance_year_1">
						<div class="form-group">
							<label for="surveillance_year_1">1st Year Surveillance</label>
							<input type="number" class="form-control" name="iso-surveillance_year_1" title="1st Year Surveillance" value="<?= $quotation->surveillance_year_1 ?>" required>
						</div>
					</div>
					<div class="col-6 assesment_fee" id="iso-surveillance_year_2">
						<div class="form-group">
							<label for="surveillance_year_2">2nd Year Surveillance</label>
							<input type="number" class="form-control" name="iso-surveillance_year_2" title="2nd Year Surveillance" value="<?= $quotation->surveillance_year_2 ?>" required>
						</div>
					</div>
					<div class="col-6 assesment_fee" id="iso-transportation">
						<div class="form-group">
							<label for="transportation">Airfare + Local Transportation + Others</label>
							<input type="text" class="form-control assesment_fee_transportation iso_assesment_fee_transportation" name="iso-transportation" title="Airfare + Transportation" value="<?= $quotation->transportation ?>" required>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
