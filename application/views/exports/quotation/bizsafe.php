        ...
        <main>
			<div class="container" style="page-break-after: always; font-size: 11px;">
				<div style="page-break-after: always; text-align:justify">
					...
					<b><u>Ms. Viji – Sales & Marketing Manager</u></b><br>
				...
				<div style="page-break-before: always;">
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td>
									<?php foreach ($quotation->certification_scheme_arr as $certification_scheme) {
										echo $certification_scheme . '<br>';
									}?>
								</td>
							</tr>
							<tr>
					...
					<table class="table">
						<tbody>
							<tr>
								<td width="70%" style="text-align:right;"><b>RM Audit Fees:</b></td>
								<td><?= money_number_format($quotation->audit_fee, $quotation->address->country) ?></td>
							</tr>
							<tr>
			...
			<div class="container" style="text-align:justify; font-size: 11px;">
				...
				<p>This Agreement is entered into basis of Quote Ref: <?= $quotation->number ?>. It is further governed by the
					...
					data in this form. Any data found to be false may invalidate the certification.</p>

				<p>Client is subjected to external accreditation bodies assessors’ verification, where required</p>

				<p>Any postponement / cancellation of scheduled assessment within 7 working days of the scheduled assessment dates will be subjected to a postponement / cancellation charge of $300 (exclude GST).</p>

				<p>A fee of $500 (excluding GST) will be charged for the issue of additional reprinting or replacement
					of original certificate of approval issued. Advanced System Assurance Pte Ltd reserves the right to
					accept or reject assessment application /proposal.</p>
