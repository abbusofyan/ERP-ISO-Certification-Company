<div class="content-wrapper container-xxl p-0">
		...
		<div class="content-header-left col-md-12 col-12 mb-2">
			<div class="d-flex justify-content-between">
					...
					<div class="row breadcrumbs-top">
	                    ...
	                    <div class="breadcrumb-wrapper">
	                        <ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">POC
	                            </li>
	                        </ol>
	                    </div>
					</div>
				...
				<div class="p-0">
					...
					<button type="button" class="btn btn-primary " name="button"><i data-feather="eye" class="mr-1"></i> View History</button>
    ...
    <div class="content-body">
		...
		<div class="btn-group btn-block" role="group" aria-label="Basic example">
			<button type="button" class="btn btn-primary active"><i data-feather="users" class="mr-1"></i> POC</button>
			<button type="button" class="btn btn-primary"><i data-feather="map-pin" class="mr-1"></i> Address</button>
			<button type="button" class="btn btn-primary"><i data-feather="folder" class="mr-1"></i> Application Form</button>
			<button type="button" class="btn btn-primary"><i data-feather="file-text" class="mr-1"></i> Quotation</button>
		</div>
		<br><br>
		<div class="row">
            <div class="col-12">
                <div class="card">
						...
						<div class="pull-right">
							<select class="form-control" id="poc-select">
								...
								<?php foreach ($client->contact as $contact): ?>
									<option value="<?= $contact->id ?>" <?= $contact->id == $primary_contact->id ? 'selected' : '' ?>><?= $contact->name ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
                    <div class="card-body">
                        <div class="row mt-2">
                            <div class="col-2">
								<p>Position</p>
								<b><?= $primary_contact->position ?></b>
                            </div>
							<div class="col-2">
								<p>Department</p>
								<b><?= $primary_contact->department ?></b>
                            </div>
							<div class="col-2">
								<p>Mobile</p>
								<b><?= $primary_contact->mobile ?></b>
                            </div>
							<div class="col-2">
								<p>Phone (Direct)</p>
								<b><?= $primary_contact->phone ?></b>
                            </div>
							<div class="col-2">
								<p>Fax (Direct)</p>
								<b><?= $primary_contact->fax ?></b>
                            </div>
							<div class="col-2">
								<p>Email</p>
								<b><?= $primary_contact->email ?></b>
                            </div>
                        </div>
                    </div>
                </div>
