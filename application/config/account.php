...
/**
* Based on Ion Auth (2.5.2)
*
* Author: Khairul Anwar
*		  khairul@webimp.com.sg
*         @khairulanwar
*/
 ...
 */
$config['site_title']                 = "ASA Web Application";         // Site Title, example.com
$config['admin_email']                = "noreply@asasg.com"; // Admin Email, admin@example.com
$config['default_group']              = 'superadmin';            // Default group, use name
 ...
 */
$config['email_forgot_password_complete'] = 'reset_success.tpl.php';
